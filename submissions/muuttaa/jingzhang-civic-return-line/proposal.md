...
| 层级 | 关键问题 | 本方案交付 |
| --- | --- | --- |
| 统筹研究范围，约43.6平方公里 | 海淀 AI 产业、人才和未来城市如何协同 | “高校策源—开源协作—企业转化—公共体验—国际传播”创新链 |
| 总体设计范围，约11.4平方公里 | 城市更新、交通、蓝绿和服务如何落图 | 一条开放轨道主脊、东西缝合接口和可复算空间图层 |
| 三处重点区域，合计约368.4公顷 | 具体片区如何形成可实施项目 | 三类创新客厅、十个场景卡和近期—中期—长期项目包 |

重点区证据从独立图层读取 [data:geometry/key_areas.geojson#PROV-KEY-001]。北京 AI 原点社区旧临时矩形已删除；机器校验所需的 Polygon 改为以原点大厦、五道口站和京张铁路遗址公园为位置控制的 104.3 公顷等面积研究包络 [data:geometry/key_areas.geojson#PROV-KEY-002]。它不在图纸上显示为社区边界，也不得解释为官方四至。
...
指标分三类管理 [depth:metrics_recalculation]：几何指标可直接复算；法定控制指标等待官方材料；运营绩效通过真实试点监测。临时总体范围约 11.41 平方公里 [metric:site_area_sqm]，绿地比例约 12.34%，公共空间比例约 7.33%，建筑基底比例约 2.72%。这些是当前临时几何的低置信度设计量，不是审定控制值。
